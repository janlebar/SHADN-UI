...
export default function Home() {
  ...
  <CarouselContent>
    {images.map((image, index) => (
      <CarouselItem key={index} className="pl-0 md:pl-0 md:basis-1/3 lg:basis-1/4 max-w-xs">
        <div className="flex flex-col items-center justify-center max-w-md mx-auto p-0.5">
          <img
            src={image.src}
            alt={image.title}
