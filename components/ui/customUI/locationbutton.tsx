...
const LocattionButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
...
LocattionButton.displayName = "Button";

// Custom button component that includes the SVG icon
const LocationButton = ({ children, ...props }) => {
  return (
...
export { LocattionButton, buttonVariants, LocationButton };
